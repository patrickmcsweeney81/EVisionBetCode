...
def extract_h2h_odds(
    bookmaker_data: Dict, betfair_commission: float = 0.06, for_fair_calc: bool = True
) -> Dict[str, float]:
    """
...
def process_h2h_event_v2(
    ...
    return {
        "fair": {"home": fair_prices["A"], "away": fair_prices["B"]},
...
def process_h2h_event(
    event: Dict, home_team: str, away_team: str, betfair_commission: float = 0.06
) -> Dict:
    """
    ...
    return {
        "fair": {"home": fair_prices["A"], "away": fair_prices["B"]},
        "pinnacle": {"home": pin_home or 0, "away": pin_away or 0},
        "betfair": {"home": bf_home or 0, "away": bf_away or 0},
        "bookmakers": all_book_odds,
    }
