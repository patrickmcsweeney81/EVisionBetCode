        ...
        for player_name, lines in players.items():
            for line in lines:
                ...
                for bk in bookmakers:
                    ...
                    if bkey == "pinnacle":
                        prop_odds = extract_player_prop_odds(
                            bk, player_name, line, market_key, include_au=False
                        )
                        if prop_odds:
                        ...
                        prop_odds = extract_player_prop_odds(
                            bk, player_name, line, market_key, include_au=True
                        )
                        if prop_odds:
                ...
                for bk in bookmakers:
                    ...
                    if bkey not in SHARP_BOOKIES:
                        continue
                    prop_odds_sharp = extract_player_prop_odds(
                        bk, player_name, line, market_key, include_au=False
                    )
