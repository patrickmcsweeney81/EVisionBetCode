...
def process_spread_event(
    ...
    fair_prices_v2 = build_fair_prices_two_way(
        bookmaker_odds_home, bookmaker_odds_away, market_type="main", sport=sport
    )
